...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFF85C5C);
  late Color secondary = const Color(0xFFFF9D8D);
  late Color tertiary = const Color(0xFFFFC6A5);
  late Color alternate = const Color(0xFFF9CB9C);
  ...
  late Color accent1 = const Color(0xFFFF9D8D);
  late Color accent2 = const Color(0xFFFFC6A5);
  late Color accent3 = const Color(0xFFF9CB9C);
  late Color accent4 = const Color(0xFFD1E8E2);
  late Color success = const Color(0xFFB0F0B3);
  late Color warning = const Color(0xFFF9CB9C);
  late Color error = const Color(0xFFFF6B6B);
  late Color info = const Color(0xFFD1E8E2);
}
